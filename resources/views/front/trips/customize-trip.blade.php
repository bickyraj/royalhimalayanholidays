...
<section class="hero hero-alt relative">
    ...
    <div class="overlay absolute">
        <div class="container ">
            <h1 class="font-display upper">Customize {{ $trip->name }}</h1>
            ...
            <div class="lg:col-span-2 xl:col-span-3">
                <form action="">
                    ...
                    <div class="form-group mb-8">
                        ...
                        <textarea class="form-control block" name="address" id="address" rows="5" placeholder="Address"></textarea>
                    </div>
                    <h2 class="fs-lg bold text-primary mb-2">Custom tour details</h2>
                    <div class="form-group mb-4">
                        <label for="duration" class="text-sm">Tour Duration <span class="text-xs">(in days)</span></label>
                        <input type="number" min="1" max="365" name="duration" class="form-control" id="duration" placeholder="Duration (days)">
                    </div>
                    <div class="form-group mb-4">
                        <label for="groupsize" class="text-sm">No. of Travellers</label>
                        <input type="number" min="1" name="no_of_travellers" max="100" class="form-control" id="groupsize" placeholder="No. of Travellers">
                    </div>
                    <div class="form-group mb-4">
                        <label for="pricerange" class="text-sm">Price range</label>
