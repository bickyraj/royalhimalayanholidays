            ...
            <div class="lg:col-span-2 xl:col-span-3 relative">
                    ...
                    <div>
                        ...
                        <div class="mb-6 grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div class="flex aic lg:col-span-2">
                                ...
                                <div>
                                    ...
                                    <div>
                                        Lukla - Namche Bazzar - Tengboche - Dinboche - Kongma La - Gorakshep - Everest
                                        Base camp -
                                        Kalapathar
                                        -
                        ...
                        <div class="px-3">
                            ...
                            <ul class="highlights mb-4">
                                @for ($i = 0; $i < 5; $i++) <li class="flex mb-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                        class="w-4 h-4 flex-shrink-0 text-accent mr-2">
                                        <path
                                            d="M497.4 70a19.3 19.3 0 00-27.3 0L238.6 300.8 155 210.1a19.3 19.3 0 00-28.4 26.2l97 105.5c3.7 3.8 8.6 6 13.9 6.2h.4c5 0 10-2 13.6-5.6L497.3 97.3a19.3 19.3 0 000-27.3z"
                                            fill="currentColor" />
                                        <path
                                            d="M492.7 236.7a19.3 19.3 0 00-19.3 19.3A217.6 217.6 0 01256 473.4 217.7 217.7 0 0138.6 256 217.7 217.7 0 01256 38.6 19.3 19.3 0 10256 0 256.3 256.3 0 000 256c0 141.2 114.8 256 256 256s256-114.8 256-256c0-10.7-8.6-19.3-19.3-19.3z"
                                            fill="currentColor" />
                                    </svg>
                                    {{ $faker-> text() }}
                                    </li>
                            ...
                            <div id="overview-text" class="lim collapse">
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean quis semper mi.
                                    Etiam eu magna a risus
                                    bibendum elementum a at tortor. Aenean a laoreet diam. Proin vitae semper diam. Ut
                                    dapibus rhoncus
                                    venenatis. Aenean accumsan nisl sed nisi lobortis, eget vehicula metus placerat.
                                    Nunc interdum tincidunt
                                    lectus, et malesuada neque. Maecenas id arcu erat. Nullam ullamcorper metus purus,
                                    ac sagittis ante
                                    molestie
                                    et. Proin consectetur arcu quis mattis consequat. Vestibulum elit ligula, maximus id
                                    posuere eleifend,
                                    consectetur non sem. Vivamus sollicitudin ipsum vitae nisl vulputate mollis. Etiam
                                    feugiat nunc a quam
                                    consequat mattis. Vivamus feugiat, ante pretium facilisis rhoncus, nibh urna
                                    eleifend lacus, iaculis
                                    accumsan sem neque nec nibh. Aliquam scelerisque pulvinar rhoncus.
                                </p>

                                <p>
                                    Nunc tempus risus quis mi placerat egestas. In euismod est non felis pulvinar, sed
                                    pretium mauris
                                    vehicula.
                                    Interdum et malesuada fames ac ante ipsum primis in faucibus. Curabitur non lacus
                                    vitae est blandit
                                    ultrices
                                    eu laoreet enim. Maecenas et erat lectus. Proin ut nibh at turpis pellentesque
                                    dignissim eu imperdiet
                                    neque.
                                    Phasellus bibendum varius eros, non eleifend tellus. Etiam sit amet congue ante. Ut
                                    ultrices id mauris
                                    quis
                                    eleifend. Vestibulum volutpat erat erat, eu tincidunt felis rhoncus ac. In
                                    condimentum leo ut turpis
                                    elementum porta. Nullam dapibus enim enim, sit amet sodales nunc mollis nec.
                                    Vestibulum condimentum mi
                ...
                <div id="itinerary" class="tds pt-10 bg-white px-4 lg:px-10 pb-4 mb-4" x-data="{
                    ...
                    <div class="lg:flex justify-between items-center bg-light p-4">
                        ...
                        <a href="{{ route('tours.customize', $tour->slug) }}"
        ...
        <div class="mb-8">
            ...
            <div class="card-body p-0">
                <a data-fancybox data-caption="Annapurna Base Camp Trek Map"
                    href="{{ asset('img/annapurnaregion-01.jpg') }}">
        ...
        <div class="mb-8">
            ...
            <a href="#" class="block mb-2">
                <div class="px-2 py-4 text-white"
                    style="background: linear-gradient(rgba(0,0,0,.5), rgba(0,0,0,.5)), center / cover url('{{ asset('img/'.$tour->image) }}')">
