<div class="price-card bg-primary mb-6 pt-4">
    ...
    <div class="p-4 text-white">
        <div class="">
            ...
            <s class="font-bold text-xl">$2,400</s>
        </div>
        <div class="mb-2 font-display mb-0">
            <span class="font-bold text-2xl">USD $</span>
            <span class="font-bold text-5xl text-accent">2,000</span>
            <span class="text-xl">per person</span>
        </div>
        <div class="mb-2 text-center">
            <a href="{{ route('tours.book', $tour->slug) }}" class="mb-2 btn btn-accent w-full">Book Now</a>
            <a href="{{ route('tours.customize', $tour->slug) }}" class="btn btn-accent">
        ...
        <div class="actions p-1">
            ...
            <a href="#" class="flex items-center p-1 text-accent" title="Share tour">
                <svg class="w-4 h-4 flex-shrink-0 mr-2">
                    <use xlink:href="{{ asset('img/sprite.svg') }}#share" />
                </svg>
