...
@section ('content')
    ...
    <section class="hero hero-alt relative">
        ...
        <div class="overlay absolute">
            <div class="container ">
                <h1 class="font-display upper">Customize {{ $tour->name }}</h1>
                ...
                <div class="lg:col-span-2 xl:col-span-3">
                    <form action="">
                        ...
                        <div class="form-group mb-8">
                            ...
                            <textarea class="form-control block" id="address" rows="5" placeholder="Address"></textarea>
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="number" min="1" max="365" class="form-control" id="duration" placeholder="Duration (days)">
                        </div>
                        <div class="form-group mb-4">
                            <label for="groupsize" class="text-sm">No. of Travellers</label>
                            <input type="number" min="1" max="100" class="form-control" id="groupsize" placeholder="No. of Travellers">
                        </div>
                        <div class="form-group mb-4">
                            <label for="pricerange" class="text-sm">Price range</label>
                            <select name="" id="pricerange" class="form-control">
