...
@section ('title', 'Annapurna Base Camp Trek Gallery')
...
@section ('content')
    ...
    <section class="hero hero-alt relative">
        ...
        <div class="overlay absolute">
            <div class="container ">
                <h1 class="font-display upper">Annapurna Base Camp Trek Gallery</h1>
                <div class="breadcrumb-wrapper">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb fs-sm wrap">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('gallery') }}">Gallery</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Annapurna Base Camp Trek</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-3 xl:grid-cols-4 gap-10">
                <div class="lg:col-span-2 xl:col-span-3">
                    <div class="gallery grid grid-cols-2 md:grid-cols-3 gap-4">
                        @for ($i = 0; $i < 10; $i++)
                            <a data-fancybox="gallery" href="{{ asset('img/hero.jpg') }}" class="item" data-caption="Annapurna Mountain {{ $i + 1 }}">
                                <div class="relative">
