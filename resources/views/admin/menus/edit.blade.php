                ...
                <form class="kt-form" id="add-form-page" enctype="multipart/form-data">
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-3">
                                <input type="text" class="form-control" name="name" value="{{ $menu->name }}" placeholder="name">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col">
                                ...
                                <div class="cf nestable-lists">
                                    ...
                                    <div class="dd" id="nestable2">
                                        <ol class="{{ (iterator_count($menu_items))?'dd-list': 'dd-empty' }}">
                                            @if($menu_items)
                                                @foreach($menu_items as $menu)
                                                <li class="dd-item" data-link="{{ $menu->link }}" data-type="{{ $menu->type }}" data-name="{{ $menu->name }}" data-id="<?php echo (($menu->menu_itemable_type == null)?1:$menu->menu_itemable_id);?>">
                                                    <div class="dd-handle">{{ $menu->name }}</div>
                                                    @if($menu->children)
                                                    @include('admin.menus.child-menu', ['children' => $menu->children()->orderBy('display_order', 'asc')->get()])
                                                    @endif
                                                </li>
                                                @endforeach
                                            @endif
